<script>
  ...
  const flow = [
    ['1','Собрать','Подключить API или таблицу и задать, как часто обновлять данные.','#scenario'],
    ['2','Привести','Система определит дату, сущности и метрики, предложит нормализацию.','#data-products'],
    ['3','Исследовать','Найти сильные связи, кластеры и аномалии в 3D.','#insights'],
    ['4','Спрогнозировать','Получить диапазон будущих результатов и вероятность достижения цели.','#forecasts'],
