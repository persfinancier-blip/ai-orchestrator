  ...
  function apiConfigsSystemTemplate(): DataContract {
    return {
      ...
      columns: withRequiredTableFields([
        ...
        { field_name: 'auth_mode', field_type: 'text', description: 'режим авторизации (manual/oauth2/custom)' },
        { field_name: 'auth_json', field_type: 'jsonb', description: 'строка JSON авторизации' },
        { field_name: 'oauth2_token_url', field_type: 'text', description: 'OAuth2 token URL' },
        { field_name: 'oauth2_client_id', field_type: 'text', description: 'OAuth2 client_id' },
        { field_name: 'oauth2_client_secret', field_type: 'text', description: 'OAuth2 client_secret' },
        { field_name: 'oauth2_grant_type', field_type: 'text', description: 'OAuth2 grant_type' },
        { field_name: 'oauth2_token_field', field_type: 'text', description: 'OAuth2 token_field' },
        { field_name: 'oauth2_expires_field', field_type: 'text', description: 'OAuth2 expires_field' },
        { field_name: 'oauth2_token_type_field', field_type: 'text', description: 'OAuth2 token_type_field' },
        { field_name: 'parameter_definitions', field_type: 'jsonb', description: 'определения параметров (json)' },
        { field_name: 'response_targets', field_type: 'jsonb', description: 'настройки таблиц и полей ответа' },
        { field_name: 'picked_paths', field_type: 'jsonb', description: 'выбранные пути из ответа (json)' },
        { field_name: 'example_request', field_type: 'text', description: 'Пример запроса' },
        { field_name: 'pagination_enabled', field_type: 'boolean', description: 'включена ли пагинация' },
        { field_name: 'pagination_strategy', field_type: 'text', description: 'тип пагинации' },
        { field_name: 'pagination_target', field_type: 'text', description: 'куда подставлять курсоры' },
        { field_name: 'pagination_data_path', field_type: 'text', description: 'путь к данным в ответе' },
        { field_name: 'pagination_page_param', field_type: 'text', description: 'параметр страницы' },
        { field_name: 'pagination_start_page', field_type: 'int', description: 'начальная страница' },
        { field_name: 'pagination_limit_param', field_type: 'text', description: 'параметр лимита' },
        { field_name: 'pagination_limit_value', field_type: 'int', description: 'значение лимита' },
        { field_name: 'pagination_cursor_req_path_1', field_type: 'text', description: 'первая школа запроса cursor' },
        { field_name: 'pagination_cursor_req_path_2', field_type: 'text', description: 'вторая школа запроса cursor' },
        { field_name: 'pagination_cursor_res_path_1', field_type: 'text', description: 'первая школа ответа cursor' },
        { field_name: 'pagination_cursor_res_path_2', field_type: 'text', description: 'вторая школа ответа cursor' },
        { field_name: 'pagination_next_url_path', field_type: 'text', description: 'путь next_url' },
        { field_name: 'pagination_max_pages', field_type: 'int', description: 'макс страниц' },
        { field_name: 'pagination_delay_ms', field_type: 'int', description: 'задержка между запросами (мс)' },
        { field_name: 'pagination_custom_strategy', field_type: 'text', description: 'кастомная стратегия пагинации' },
