...
<div class:table-node-builder={true} class:table-node-builder-embedded={embeddedMode}>
  <section class="shell-strip">
    <div class="shell-strip-copy">
      ...
      <p>Зона для параметров из предыдущей ноды. Наполнение появится на следующем шаге.</p>
    </div>
    <span class="shell-strip-chip">Пока без содержимого</span>
  </section>
