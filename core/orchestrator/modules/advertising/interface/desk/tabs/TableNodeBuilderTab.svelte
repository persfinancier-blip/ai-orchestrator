...
<div class:table-node-builder={true} class:table-node-builder-embedded={embeddedMode}>
  <section class="shell-section">
    ...
    <div class="empty-box">Пока нет данных для отображения входных параметров.</div>
  </section>
