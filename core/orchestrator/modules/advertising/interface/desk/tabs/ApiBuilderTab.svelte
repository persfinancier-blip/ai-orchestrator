...
<style>
  ...
  .parameter-preview-block { border:1px solid #e6eaf2; border-radius:12px; padding:10px; background:#fff; width:100%; max-width:276px; overflow-x:auto; box-sizing:border-box; margin:0 auto; }
