...
<style>
  ...
  .parameter-preview-block { border:1px solid #e6eaf2; border-radius:12px; padding:10px; background:#fff; width:320px; min-width:320px; max-width:320px; overflow-x:auto; box-sizing:border-box; }
