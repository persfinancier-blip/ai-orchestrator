...
<style>
  ...
  .parameter-preview-block { border:1px solid #e6eaf2; border-radius:12px; padding:10px; background:#fff; width:100%; max-width:calc(100vw - 708px); overflow-x:auto; box-sizing:border-box; margin:0 auto; }`n  @media (max-width: 708px) {`n    .parameter-preview-block { max-width:100%; }`n  }
