...
export type AllowedRole = 'entity' | 'axis' | 'filter';
...
export const FIELDS: FieldDef[] = [
  ...
  { code: 'entry_point', name: 'Точка входа', fieldType: 'dimension', valueType: 'string', allowedRoles: ['entity', 'filter'], datasetIds: ['sales_fact', 'ads'] },
  { code: 'keyword_cluster', name: 'Кластер РК', fieldType: 'dimension', valueType: 'string', allowedRoles: ['entity', 'filter'], datasetIds: ['ads'] },
  { code: 'search_query', name: 'Поисковый запрос', fieldType: 'dimension', valueType: 'string', allowedRoles: ['entity', 'filter'], datasetIds: ['ads'] },
  ...
  { code: 'cr2', name: 'CR2', fieldType: 'measure', valueType: 'number', allowedRoles: ['axis', 'filter'], datasetIds: ['ads'] },
